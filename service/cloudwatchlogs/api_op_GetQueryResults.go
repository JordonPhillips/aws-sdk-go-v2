...
// record. You can use the value of @ptr in a operation to get the full log record.
// GetQueryResults does not start a query execution. To run a query, use . If the
// value of the Status field in the output is Running, this operation returns only
// partial results. If you see a value of Scheduled or Running for the status, you
